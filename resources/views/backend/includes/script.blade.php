<script src="{{asset('Backend/lib/jquery/jquery.min.js')}}"></script>
    ...
    {{-- Interactive page --}}
    <script src="{{asset('Backend/js/page.route.js')}}"></script>
    <script src="{{asset('Backend/page_crud/slider.js')}}"></script>
    <script src="{{asset('Backend/page_crud/teacher.js')}}"></script>
